...
const DSH_SPECIFIC = ['radar', 'lanshu', 'awesome']
 ...
 *
 * An unknown timestamp scores 0.85, NOT zero. Only two of five sources
 * publish `pushedAt`, so most entries have no date at all; treating "unknown"
